...
@section('title-block','Места для проживания')
...
<!--        <div class="filter-group filter-business">
            <div class="categoryes-filter">
                ...
                </div>&lt;!&ndash; .filter &ndash;&gt;
            </div>
        </div>&lt;!&ndash; .filter-group &ndash;&gt;-->
                ...
                <div class="main-primary">
                    <div class="filter-mobile">
                        <ul>
                            ...
                            <li><a class="mb-sort mb-open" href="#sortForm">Сортировать по</a></li>
                        </ul>
...
<!--                            <span class="result-count"><span class="count">4</span> результата</span>
                        ...
                        <div class="filter-right">
                            <div class="select-box">
                                <form action="{{route('reservation_place')}}" id="sort_form" method="POST">
                                <select name="sort_by" id="sort-by" class="sort-by">
                                ...
                                <div class="filter-control" tabindex="0">
                                    ...
                                    <ul class="list">
                                        ...
                                        <li data-value="date" class="option">Дате</li>
                                        <li data-value="name" class="option">Названию</li>
                                        <li data-value="rating" class="option">Рейтингу</li>
                                        <li data-value="price" class="option">Цене</li>
                                    </ul>
                                </div>
                            </div><!-- .select-box -->
                            ...
                            <div class="place-item layout-02 place-hover" data-maps_name="{{$place->id}}">
                                <div class="place-inner">
                                    <div class="place-thumb">
                                        <a class="entry-thumb" href="{{route('single-base-place',$place->id)}}"><img src="{{\Illuminate\Support\Facades\Storage::url($place->cover_image)}}" alt="{{$place->cover_image}}"></a>
                                        <a href="#" class="golo-add-to-wishlist btn-add-to-wishlist " data-place-id="185">
											<span class="icon-heart">
												<i class="la la-bookmark large"></i>
											</span>
                                        </a>
                                        <a class="entry-category orange-light" href="#">
                                            <i class="las la-home"></i><span>База отдыха</span>
                                        </a>
                                    </div>
                                        ...
                                        <div class="entry-bottom">
                                            <div class="place-preview">
                                                <div class="place-rating">
                                                    <span>{{$place->getAverageMark()}}</span>
                                                    <i class="la la-star"></i>
                                                </div>
                                                <span class="count-reviews">({{$place->reviews->count()}} отзыва)</span>
                                            </div>
                                            <div class="place-price">
                                                <span>от {{$place->minPrice()}} BYN</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        var places_data = [
                @foreach ($places as $place)
                    ...
                    {id:'{{$place->id}}',images:'{{$place->cover_image}}', coordinates: '{{$place->coordinates}}', name: '{{$place->name}}', category: 'База отдыха', price: {{$place->minPrice()}}, rating: {{$place->getAverageMark()}}, },
