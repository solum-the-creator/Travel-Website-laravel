...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $('.slick-sliders').each(function () {
      ...
      slick_slider.slick((_slick_slider$slick = {
        ...
        fade: fade,
        cssEase: cssEase
      }, _defineProperty(_slick_slider$slick, "infinite", infinite), _defineProperty(_slick_slider$slick, "speed", speed), _defineProperty(_slick_slider$slick, "arrows", arrows), _defineProperty(_slick_slider$slick, "slidesToShow", item), _defineProperty(_slick_slider$slick, "slidesToScroll", itemScroll), _defineProperty(_slick_slider$slick, "prevArrow", $(this).find('.place-slider__prev')), _defineProperty(_slick_slider$slick, "nextArrow", $(this).find('.place-slider__next')), _defineProperty(_slick_slider$slick, "asNavFor", asNavFor), _defineProperty(_slick_slider$slick, "responsive", [{
        breakpoint: 1200,
        settings: {
    ...
    $('.accordion-top label').on('click', function (e) {
      ...
      if ($(this).find('input').is(':checked')) {
        console.log("is unchecked"); // _this.find('.accordion-top > span').text("Closed111");

        $(this).find('input').prop('checked', false);
      } else {
        console.log("is checked"); // _this.find('.accordion-top > span').text("Closed222");
    ...
    $('.accordion-item').each(function () {
      ...
      _this.find('select').change(function () {
        ...
        if (open_time != open_first && close_time != close_first) {
          _this.addClass('active'); // _this.find( '.accordion-bot' ).slideUp();
    ...
    $(document).mouseup(function (e) {
      var container = $(".toggle-select"); // if the target of the click isn't the container nor a descendant of the container
      ...
      $('.listing-box').each(function (i) {
        if ($(this).position().top <= scrollDistance + 150) {
          ...
          $('.nav-scroll a').each(function () {
            var attr = $(this).attr('href'); // For some browsers, `attr` is undefined; for others, `attr` is false. Check for both.
    ...
    $(document).mouseup(function (e) {
      var container = $('.widget'); // if the target of the click isn't the container nor a descendant of the container
    ...
    $(document).mouseup(function (e) {
      var container = $('.box-option'); // if the target of the click isn't the container nor a descendant of the container
    ...
    $(document).mouseup(function (e) {
      var container = $('.account'); // if the target of the click isn't the container nor a descendant of the container
    ...
    $(document).mouseup(function (e) {
      var container = $("ul.list"); // if the target of the click isn't the container nor a descendant of the container
    ...
    $(document).mouseup(function (e) {
      var container = $(".place-share"); // if the target of the click isn't the container nor a descendant of the container
    ...
    $(document).mouseup(function (e) {
      var container = $(".field-select.has-sub"); // if the target of the click isn't the container nor a descendant of the container
